...
document.getElementById('floatform').onsubmit=function(){
  if(email2.value=="" || email2.value=="sales@aeether.com" || email2.value=="aeether2009@gmail.com"){
...
document.getElementById('footer-form').onsubmit=function(){
  if(email3.value=="" || email3.value=="sales@aeether.com" || email3.value=="aeether2009@gmail.com"){
...
for (let i = 0; i < floatButton.length; i++) {
  ...
  xhr.open("POST", "/AEETHER/send-data.html", true);
